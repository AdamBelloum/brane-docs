...
If your Brane installation includes remote worker nodes, simply run the same command —
...
Brane provides a **REPL (Read–Eval–Print Loop)** to experiment with BraneScript interactively.
...
>The REPL is great for quick exploration — testing functions, learning syntax, or debugging.

---

## 6. Example: “HelloWorld” Workflow

Here’s a complete BraneScript example you can try right away.
